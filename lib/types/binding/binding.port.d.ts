...
import type { BackendActionRequest, BackendActionResult, BackendCursorAction, BackendCursorActivation, BackendHealth, BackendObservation, BackendObserveOptions, BackendTrackedDragResult, CursorVisibility } from '../optics/optics.sighting.ts';
/**
 ...
 */
export type { BackendActionRequest, BackendActionResult, BackendCursorAction, BackendCursorActivation, BackendHealth, BackendObservation, BackendObserveOptions, BackendTrackedDragResult, CursorVisibility, };
...
//# sourceMappingURL=binding.port.d.ts.map