...
import type { ComputerConfirmationToken, ComputerObservationId, ComputerTargetHandle } from './charter.identity.ts';
import type { ComputerObservation, ComputerTargetResolutionResult } from './charter.observation.ts';
...
export type ComputerActionRequest = ComputerClickAction | ComputerScrollAction | ComputerDragAction | ComputerPressKeyAction | ComputerSetValueAction | ComputerTypeTextAction | ComputerPerformAction | ComputerWaitAction;
/**
...
//# sourceMappingURL=charter.action.d.ts.map