 ...
 */
import type { ComputerActionRequest, ComputerAppIdentity, ComputerElement, ComputerPermissionState, ComputerRect, ComputerScreenshotMode, CursorVisibility } from '../charter/charter.index.ts';
...
//# sourceMappingURL=optics.sighting.d.ts.map