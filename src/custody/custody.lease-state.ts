...
import type {
  ComputerUseDeniedLease,
  ComputerUseSessionIdentity,
  ComputerUseSessionState,
} from '../charter/charter.custody.ts'
...
export {
  computerUseSessionStateSchema,
  computerUseStateDomainSpec,
} from '../charter/charter.custody.ts'
export type {
  ComputerLeaseSource,
  ComputerUseDeniedLease,
...
export function currentTurn(events: readonly SessionEvent[]): number | undefined {
...
export function identityOf(header: SessionHeader): ComputerUseSessionIdentity {
...
export function sameIdentity(row: ComputerUseSessionState, header: SessionHeader): boolean {
...
export function configuredAccess(config: ResolvedComputerUseConfig, bundleId: string, scope: 'read' | 'control'): boolean {
