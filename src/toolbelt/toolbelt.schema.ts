...
const permissionStates = ['granted', 'denied', 'not-determined', 'unavailable'] as const
...
export function actionBase(args: { observationId: string; sensitive?: boolean; confirmationToken?: string }) {
...
export function elementTarget(args: { elementIndex?: number; targetHandle?: string; allowRebind?: boolean }) {
