...
import { defineTool, type ToolDefinition, type ToolCallKind, type ToolCallView } from '@deepseek-ai/dsh-tools'
import {
  ComputerObservationId,
  type ComputerActionRequest,
} from '../charter/charter.index.ts'
import type { ComputerUseService } from '../conductor/conductor.service.ts'
import {
  actionOutput,
  contextOf,
  deferVisionHandoff,
  renderJson,
} from './toolbelt.handoff.ts'
import {
  actionBase,
  appSchema,
  appSelectorSchema,
...
const POINTER_BUTTON = { type: 'string', enum: ['left', 'right', 'middle'] } as const
...
function present(title: string, kind: ToolCallKind): () => ToolCallView {
...
function appListTool(service: ComputerUseService): ToolDefinition {
  return defineTool({
...
function observationTool(service: ComputerUseService): ToolDefinition {
  return defineTool({
...
function clickTool(service: ComputerUseService): ToolDefinition {
  return defineTool({
    name: 'computer_click',
...
function setValueTool(service: ComputerUseService): ToolDefinition {
  return defineTool({
...
function typeTextTool(service: ComputerUseService): ToolDefinition {
  return defineTool({
...
function pressKeyTool(service: ComputerUseService): ToolDefinition {
  return defineTool({
...
function scrollTool(service: ComputerUseService): ToolDefinition {
  return defineTool({
...
function dragTool(service: ComputerUseService): ToolDefinition {
  return defineTool({
    name: 'computer_drag',
...
function performActionTool(service: ComputerUseService): ToolDefinition {
  return defineTool({
...
function waitTool(service: ComputerUseService): ToolDefinition {
  return defineTool({
    name: 'computer_wait',
...
function confirmTool(service: ComputerUseService): ToolDefinition {
  return defineTool({
