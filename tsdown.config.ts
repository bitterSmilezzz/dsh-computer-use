/**
 * Standalone tsdown config for dsh-computer-use — the official clientBundle
 ...
 *
 * The host half (lib/index.js and friends) is emitted by tsc (tsconfig.json)
 * with rewriteRelativeImportExtensions, mirroring the official node-half build.
 *
...
export default defineConfig([
  {
    ...
    outputOptions: {
      ...
      banner: 'window.__ModuleLoader__.load({ id: "@bittersmilezzz/dsh-computer-use", factory: (require) => {',
